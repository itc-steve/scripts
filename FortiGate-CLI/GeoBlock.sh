...
config firewall address
    ...
    edit "Geo_CapeVerde"
        ...
        set country "CV"
    next
    edit "Geo_CentralAfricanRepublic"
        set type geography
        set country "CF"
    next
    edit "Geo_Chad"
